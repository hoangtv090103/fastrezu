...
-- Description: Add original_content, suggested_content, keyword, and target_index columns
-- Date: 2025-10-29
...
COMMENT ON COLUMN ats_suggestions.suggested_content IS 'The content after applying the suggestion';
