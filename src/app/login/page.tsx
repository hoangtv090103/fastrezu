...
function LoginContent() {
  ...
  // Login Form Component - memoized to prevent recreation on every render
  const loginFormContent = useMemo(
    () => (
      <div
        className={showSplitView ? "" : "bg-white rounded-2xl shadow-2xl p-8"}
      >
    ...
    [showSplitView, t, handleGoogleLogin, isLoading, handleMagicLink, message]
  );
      ...
      <div className="min-h-screen h-screen flex overflow-hidden">
        ...
        <div className="w-full lg:w-[45%] bg-white flex flex-col relative">
          ...
          <div className="flex-1 flex items-center justify-center px-8 lg:px-16">
            <div className="max-w-sm w-full">{loginFormContent}</div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full">{loginFormContent}</div>
      </div>
    </div>
  );
}
