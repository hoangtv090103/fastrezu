...
export const validateEmail = (
  ...
  const messages = {
    ...
    en: {
      ...
      invalid:
        "Invalid email. Please enter a valid format (e.g., example@email.com)",
    },
  };
...
export const validatePersonalInfo = (
  ...
  // Required fields
  const fullNameResult = validateRequired(
...
export const validateExperience = (
  ...
  // Required fields
  const companyResult = validateRequired(
    String(data.company || ""),
    "Tên công ty"
  );
  errors.push(...companyResult.errors);

  const jobTitleResult = validateRequired(
...
export const validateEducation = (
  ...
  // Required fields
  const schoolResult = validateRequired(
    String(data.school || ""),
    "Tên trường"
  );
