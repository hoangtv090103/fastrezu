    ...
    <div className="flex flex-col h-full bg-gray-50 relative">
      ...
      <div className="flex flex-col lg:flex-row flex-1 min-h-0 overflow-hidden relative">
        ...
        <button
          ...
          className="lg:hidden fixed top-56 right-0 z-40 bg-gradient-to-l from-blue-500 to-blue-600 text-white pl-3 pr-2 py-3 rounded-l-xl shadow-2xl flex items-center justify-center hover:from-blue-600 hover:to-blue-700 transition-all active:scale-95"
          style={{
            boxShadow:
