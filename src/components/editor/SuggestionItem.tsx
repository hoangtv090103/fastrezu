      ...
      <div className="flex items-start justify-between gap-3">
        ...
        {!suggestion.is_applied && (
          <button
            onClick={handleApply}
            disabled={isDisabled}
            className="shrink-0 px-4 py-2 bg-purple-600 text-white text-xs font-medium rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors duration-200 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
