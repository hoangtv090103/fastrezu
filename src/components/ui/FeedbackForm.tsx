...
export default function FeedbackForm({
  ...
  const feedbackTypes = [
    {
      value: "bug_report",
      label: t("feedback.types.bugLabel"),
      description: t("feedback.types.bugDescription"),
    },
    {
      value: "feature_request",
      label: t("feedback.types.featureLabel"),
      description: t("feedback.types.featureDescription"),
    },
    {
      value: "general_feedback",
      label: t("feedback.types.generalLabel"),
      description: t("feedback.types.generalDescription"),
    },
    {
      value: "praise",
      label: t("feedback.types.praiseLabel"),
      description: t("feedback.types.praiseDescription"),
    },
  ] as const;
